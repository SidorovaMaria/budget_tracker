...
export const TYPE_OPTIONS: { value: TxType; label: string; on: string; off: string }[] = [
  {
    value: "expense",
    label: "Expense",
    on: "bg-s-red text-white ",
    off: "hover:bg-s-red/10 hover:text-s-red hover:border-s-red",
  },
  {
    value: "income",
    label: "Income",
    on: "bg-s-green text-white ",
    off: "hover:bg-s-green/10 hover:text-s-green hover:border-s-green",
  },
];
